 ...
 */
public class ChatList extends FirestoreRecyclerAdapter<Message, ChatList.ChatModelViewHolder> {

    Context context;
    String currentUserId;
    String otherUserId;

    public ChatList(@NonNull FirestoreRecyclerOptions<Message> options, Context context, String currentUserId, String otherUserId) {
        super(options);
